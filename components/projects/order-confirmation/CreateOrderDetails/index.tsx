...
function CreateOrderDetails() {
  ...
  const onSubmitForm = async (data: any) => {
    ...
    try {
      ...
      const res = await fetch(`${baseUrl}/api/projects/orders/create`, {
        method: "POST",
        body: formData,
      ...
      if (json.success) {
        toast({
          title: "New order confirmation added successfully.",
          variant: "success",
          duration: 2000,
        });
        setTimeout(() => {
    ...
    <form onSubmit={handleSubmit(onSubmitForm)}>
      <div className="flex flex-col p-5 gap-3 w-full mx-auto max-w-[1600px]">
        <div className="flex justify-between bg-background p-3 rounded-app items-center shadow-sm">
          <h1 className="text-lg font-medium">Create Order Confirmation</h1>
                  ...
                  <div className="flex items-center h-full">
                    <Checkbox
                      ...
                      onCheckedChange={(value: boolean) =>
                        setValue("order_confirmation_is_exclusive_vat", value)
                      }
                    />
                  </div>
                </div>
              ...
              <div className="flex gap-5">
                ...
                <div className="flex-1 flex flex-col gap-1">
                  ...
                  <Checkbox
                    ...
                    className="w-5 h-5 border-2 rounded-full group-hover/item:visible"
                    onCheckedChange={(value: boolean) =>
                      setValue("order_confirmation_is_not_project", value)
                    }
                  />
                </div>
              </div>
