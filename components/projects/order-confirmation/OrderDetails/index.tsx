          ...
          {data && (
            <>
              <p className="text-xl font-bold mb-4 sticky top-0 bg-white z-10">
                {data && data.order_confirmation_description}
              </p>
              <Details data={data} />
            </>
          )}
  ...
  return (
    <>
      ...
      <div className="border-2 border-stone-100 p-3 flex justify-between items-center rounded-xl mb-3">
        ...
        <StatusChip status={getOrderStatus(data)} />
      </div>
      <Detail>
      ...
      <Detail className="mb-0">
        ...
        <div>
          <p className="font-bold">
            {data.order_confirmation_is_exclusive_vat == 1
              ? "Exclusive VAT"
              : "Inclusive VAT"}
          </p>
        </div>
      ...
      <Detail className="mb-0">
        ...
        <div>
          <p className="font-bold">
            {data.order_confirmation_date
              ? dayjs(data.order_confirmation_date).format("MMMM DD, YYYY")
              : "-"}
          </p>
        </div>
      </Detail>
      ...
      <Detail className="mb-0">
        ...
        <div>
          <p className="font-bold">
            {data.order_confirmation_document_date
              ? dayjs(data.order_confirmation_document_date).format(
                  "MMMM DD, YYYY"
                )
              : "-"}
          </p>
