...
function EditInvoiceDetails({ id, invoice }: any) {
  ...
  const onSubmitForm = async (data: any) => {
    ...
    try {
      ...
      const res = await fetch(`${baseUrl}/api/projects/invoices/update/${id}`, {
        method: "POST",
          ...
          <div className="w-1/3 bg-background p-6 rounded-app shadow-sm">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex-1 flex flex-col gap-1">
                ...
                <div className="flex items-center h-full">
                  <Controller
                    name="invoice_goods_from_germany"
                    control={control}
                    render={({ field }) => (
                      <Checkbox
...
export default memo(EditInvoiceDetails);
