  ...
  return (
    <>
      ...
      <div className="border-2 border-stone-100 p-3 flex justify-between items-center rounded-xl mb-3">
        ...
        <StatusChip status={getInvoiceStatus(data)} />
      </div>
      <Detail>
      ...
      <Detail className="mb-0">
        ...
        <div>
          <p className="font-bold">
            {data.invoice_is_exclusive_vat == 1
              ? "Exclusive VAT"
              : "Inclusive VAT"}
          </p>
        </div>
      ...
      <Detail className="mb-0">
        ...
        <div>
          <p className="font-bold">
            {data.invoice_date
              ? dayjs(data.invoice_date).format("MMMM DD, YYYY")
              : "-"}
          </p>
        </div>
      </Detail>
      ...
      <Detail className="mb-0">
        ...
        <div>
          <p className="font-bold">
            {data.invoice_document_date
              ? dayjs(data.invoice_document_date).format("MMMM DD, YYYY")
              : "-"}
          </p>
        </div>
      </Detail>
