          ...
          {data && (
            <>
              <p className="text-xl font-bold mb-4 sticky top-0 bg-white z-10">
                {data && data.delivery_note_description}
              </p>
              <Details data={data} />
            </>
          )}
  ...
  return (
    <>
      ...
      <div className="border-2 border-stone-100 p-3 flex justify-between items-center rounded-xl mb-3">
        ...
        <StatusChip status={getDeliveryStatus(data)} />
      </div>
      <Detail>
      ...
      <Detail className="mb-0">
        ...
        <div>
          <p className="font-bold">
            {data.delivery_note_is_exclusive_vat == 1
              ? "Exclusive VAT"
              : "Inclusive VAT"}
          </p>
        </div>
        ...
        <div>
          <p className="font-bold">
            {data.delivery_note_date
              ? dayjs(data.delivery_note_date).format("MMMM DD, YYYY")
              : "-"}
          </p>
        </div>
      </Detail>
      ...
      <Detail className="mb-0">
        ...
        <div>
          <p className="font-bold">
            {data.delivery_note_document_date
              ? dayjs(data.delivery_note_document_date).format("MMMM DD, YYYY")
              : "-"}
          </p>
        </div>
      </Detail>
