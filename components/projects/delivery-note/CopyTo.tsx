...
const CopyTo = ({
  ...
  const deliveryDetails: any = useContext(DeliveryNoteDetailsContext);
  const _delivery_note_copy_id = deliveryDetails
    ? deliveryDetails.delivery_note_copy_id
    : null;
  const [shipping_copy_id, set_shipping_copy_id] = useState(
    _delivery_note_copy_id
  );
