...
function EditDeliveryDetails({ id, delivery_note }: any) {
  ...
  const onSubmitForm = async (data: any) => {
    ...
    try {
      ...
      const res = await fetch(
        `${baseUrl}/api/projects/deliveries/update/${id}`,
        {
          method: "POST",
      ...
      if (json.success) {
        toast({
          title: "A delivery note has been updated successfully.",
          variant: "success",
          duration: 2000,
        });
        setTimeout(() => {
          setLoadingSubmit(false);
          router.push("/projects/delivery-note/" + id);

          // send task emails
          SendTaskEmail("UPDATE_DELIVERY_NOTE", session?.user?.access_token);
        }, 300);
      }
    } catch (err: any) {
      setLoadingSubmit(false);
    ...
    <form onSubmit={handleSubmit(onSubmitForm)}>
      <div className="flex flex-col p-5 gap-3 w-full mx-auto max-w-[1600px]">
        <div className="flex justify-between bg-background p-3 rounded-app items-center shadow-sm">
          <h1 className="text-lg font-medium">Edit Delivery Note</h1>
              ...
              <div className="flex gap-5">
                ...
                <div className="flex-1 flex flex-col gap-1">
                  ...
                  <div className="flex items-center h-full">
                    <Controller
                      name="delivery_note_is_exclusive_vat"
                      control={control}
                      render={({ field }) => (
                        <Checkbox
                          id="is_exclusive_vat"
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex gap-5">
                ...
                <div className="flex flex-1  flex-col gap-1">
                  ...
                  <Controller
                    name="delivery_note_is_not_project"
                    control={control}
                    render={({ field }) => (
                      <Checkbox
                        id="is_project_label"
...
export default memo(EditDeliveryDetails);
