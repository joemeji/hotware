...
import { ShippingListContainerSizeContext } from "@/pages/projects/shipping-list";
    ...
    <div className="overflow-x-auto flex-inline">
      <table className="w-full">
        ...
        <tbody>
          ...
          {Array.isArray(data?.shipping) && data.shipping.length === 0 && (
            <tr>
              <td
                colSpan={8}
            ...
            data.shipping.map((row: any, key: number) => (
              <tr key={key} className="group">
                <TD className="ps-4 align-top">
                  <Link href={`/projects/shipping-list/${row._shipping_id}`}>
