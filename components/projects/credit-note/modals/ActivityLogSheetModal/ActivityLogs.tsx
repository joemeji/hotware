  ...
  const { data, isLoading, error, size, setSize, isValidating } =
    useSWRInfinite(
      (index) => {
        ...
        let uri = historyUri(_credit_note_id, paramsObj);
