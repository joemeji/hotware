  ...
  return (
    <>
      ...
      <div className="border-2 border-stone-100 p-3 flex justify-between items-center rounded-xl mb-3">
        ...
        <StatusChip status={getOfferStatus(data)} />
      </div>
      <Detail>
      ...
      <Detail>
        <p className="text-sm font-medium text-stone-500">Document Type</p>
        <div>
          <p className="font-bold">{data.project_type_name}</p>
        </div>
      </Detail>

      <Detail>
        <p className="text-sm font-medium text-stone-500">Industry</p>
        <div>
          <p className="font-bold">{data.cms_industry_name || "-"}</p>
        </div>
      </Detail>
      ...
      <Detail className="mb-0">
        <p className="text-sm font-medium text-stone-500">Order Probability</p>
        <div>
          <p className="font-bold">
            {data.offer_order_probability
              ? `${data.offer_order_probability}%`
              : "-"}
          </p>
        </div>
      ...
      <Detail className="mb-0">
        <p className="text-sm font-medium text-stone-500">Offer Date</p>
        <div>
          <p className="font-bold">
            {data.offer_date
              ? dayjs(data.offer_date).format("MMMM DD, YYYY")
              : "-"}
          </p>
        </div>
      </Detail>
      ...
      <Detail className="mb-0">
        ...
        <div>
          <p className="font-bold">
            {data.offer_document_date
              ? dayjs(data.offer_document_date).format("MMMM DD, YYYY")
              : "-"}
          </p>
        </div>
      </Detail>
