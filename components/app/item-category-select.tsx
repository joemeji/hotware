...
const ItemCategorySelect = (props: ItemCategorySelectProps) => {
  const {
    value,
    onChangeValue,
    placeholder,
  ...
  const { data, isLoading, error, mutate, size, setSize, isValidating } =
    useSWRInfinite((index) => {
      ...
      paramsObj["item_main_category_id"] =
        item_main_category_id && item_main_category_id;
      let searchParams = new URLSearchParams(paramsObj);
      return [`/api/item/category/all?${searchParams}`];
    }, fetcher);
  ...
  // const paramsObj: any = {};
  // if (item_main_category_id)
  //   paramsObj["item_main_category_id"] = item_main_category_id;
  // let searchParams = new URLSearchParams(paramsObj);

  // const { data, isLoading } = useSWR(
  //   `/api/item/category/all?${searchParams.toString()}`,
  //   fetcher,
  //   {
