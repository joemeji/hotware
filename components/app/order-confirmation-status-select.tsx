...
const OrderConfirmationStatusSelect = (
  props: OrderConfirmationStatusSelectProps
) => {
...
type OrderConfirmationStatusSelectProps = {
  value?: any;
...
export default OrderConfirmationStatusSelect;
