...
const SpecificDocument = (props: SpecificDocumentProps) => {
    ...
    <div className="mt-5">
      <div className="shadow-sm rounded-xl overflow-hidden bg-white">
        <div className="flex ps-1 bg-red-10 py-2 gap-1 justify-between pe-3">
          <div className="px-2">
            <p className="font-medium text-lg">Specific Documents</p>
          </div>
...
export default memo(SpecificDocument);

type SpecificDocumentProps = {
  _item_id?: any;
  access_token?: any;
};
