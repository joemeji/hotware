...
const AddButtonPopover = (props: AddButtonPopoverProps) => {
  const { onClickAddEquipmentButton, onClickAddSetButton, loadingDetails } = props;
  console.log({ details: loadingDetails })
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button variant={'ghost'} className="flex items-center gap-2 px-2" disabled={loadingDetails !== null ? false : true}>
          <Plus className="h-[18px] w-[18px] text-red-600" strokeWidth={2} /> Add Item
        </Button>
      </PopoverTrigger>
