...
function EditCmsCategoryModal(props: EditCmsCategoryModal) {
  ...
  const {
    ...
    defaultValues: {
      cms_category_name: cms.cms_category_name
    }
  });
  ...
  const handleFormSubmit = async (data: any) => {
    try {
      ...
      const res = await fetch(`${baseUrl}/api/cms/edit_category/${cms.cms_category_id}`, {
        method: 'POST',
...
export default memo(EditCmsCategoryModal);

type EditCmsCategoryModal = {
  open?: boolean,
