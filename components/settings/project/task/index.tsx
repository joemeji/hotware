...
import SettingsTaskList from "./lists/SettingsTaskList";
...
export const ActionMenu = ({
  ...
  <DropdownMenu modal={false}>
    ...
    <DropdownMenuContent align='end' className='border border-stone-50'>
      <ItemMenu onClick={() => onAddTaskTrigger(data)}>
        <Link />
        <span className='text-stone-600 text-sm'>Add Trigger</span>
      </ItemMenu>
