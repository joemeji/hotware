...
interface IProjectSecondRoleDocumentForm {
  id?: string;
  onOpenChange?: (open: boolean) => void;
}
export const ProjectSecondRoleDocumentForm = (
  props: IProjectSecondRoleDocumentForm
) => {
  ...
  const { data: productRoleDocument, isLoading: prdLoading } = useSWR(
    `/api/project/project-second-role-document/info?id=${id}`,
    fetcher
  );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const url = `/api/project/project-second-role-document/create`;
