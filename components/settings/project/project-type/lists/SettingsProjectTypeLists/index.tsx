...
import { AddProjectTypeModal } from "../../modals/AddProjectTypeModal";
import { DeleteProjectTypeConfirmModal } from "../../modals/DeleteProjectTypeConfirmModal";
import { PER_PAGE } from "@/utils/algoliaConfig";

const SettingsProjectTypeLists = () => {
  ...
  const listUrl = `/api/project/project-type/paginate?page=${page}&search=${searchText}`;
    ...
    <div className='grid bg-white'>
      ...
      <div className={cn("bg-white p-7", {})}>
        <div className='flex items-center justify-between '>
          <h1 className='text-2xl font-light mb-5'>Manage Project Type</h1>
      ...
      <div className='p-3'>
        <div className='min-h-full'>
          <table className='w-full rounded-sm overflow-hidden p-5'>
            ...
            <tbody>
              {project_type &&
                ...
                project_type.map((type: any, i: number) => {
                  return (
          ...
          {!isLoading && project_type?.length == 0 && (
...
export default memo(SettingsProjectTypeLists);
