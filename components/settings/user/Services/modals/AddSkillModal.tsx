...
export const AddNewSkillModal = (props: AddNewSkillModalProps) => {
  ...
  const handleFormSubmit = async (data: any) => {
    try {
      data.usc_id = parent_id;
      data.user_service_id = service_id;

      setLoading(true);
      const res = await fetch(`${baseUrl}/api/users/service/add_skill`, {
        method: "POST",
          ...
          <DialogTitle>
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-sm font-normal text-stone-500">
                Add skill inside this current directory
              </span>
            </div>
          </DialogTitle>
