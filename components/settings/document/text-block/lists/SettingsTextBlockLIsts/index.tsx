...
const SettingsTextBlockLists = () => {
  ...
  const listUrl = `/api/document/text-block/paginate?page=${page}&search=${searchText}`;
    ...
    <div className='grid bg-white'>
      ...
      <div className={cn("bg-white p-7", {})}>
        <div className='flex items-center justify-between '>
          <h1 className='text-2xl font-light mb-5'>Manage Text Blocks</h1>
                    ...
                    <tr key={i} className=''>
                      ...
                      <TD>
                        <p
                          ...
                          title={textBlock?.text_block_extra_text}
                        >
                          {textBlock.text_block_extra_text}
                        </p>
                      </TD>
...
export default memo(SettingsTextBlockLists);
