...
import SettingsLanguageLists from "./lists/SettingsTextBlockLIsts";
import SettingsTextBlockLIsts from "./lists/SettingsTextBlockLIsts";

export const SettingsTextBlock = () => {
  return (
    <div className=''>
