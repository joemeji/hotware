...
const SettingslanguageLists = () => {
  ...
  const listUrl = `/api/document/language/paginate?page=${page}&search=${searchText}`;
  ...
  const languages = data?.document_language;
    ...
    <div className='grid bg-white'>
      ...
      <div className={cn("bg-white p-7", {})}>
        <div className='flex items-center justify-between '>
          <h1 className='text-2xl font-light mb-5'>Manage languages</h1>
                    ...
                    <tr key={i} className='text-center &_td:border-r'>
                      ...
                      <TD>
                        <ActionMenu
                          ...
                          data={{
                            id: language.document_language_id,
                          }}
                        />
                      </TD>
                    </tr>
...
export default memo(SettingslanguageLists);
