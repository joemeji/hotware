...
import { DeleteBankAccountConfirmModal } from "../../modals/DeleteBankAccountConfirmModal";
import { PER_PAGE } from "@/utils/algoliaConfig";

const SettingsBankAccountLists = () => {
  ...
  const listUrl = `/api/invoice/bank-account/paginate?page=${page}&search=${searchText}`;
    ...
    <div className='grid bg-white'>
      ...
      <div className={cn("bg-white p-7", {})}>
        <div className='flex items-center justify-between '>
          <h1 className='text-2xl font-light mb-5'>Manage Bank Account</h1>
      ...
      <div className='p-3'>
        <div className='min-h-full'>
          <table className='w-full rounded-sm overflow-hidden p-5'>
            ...
            <tbody>
              {bank_account &&
                ...
                bank_account.map((type: any, i: number) => {
                  return (
                    <tr key={i} className='text-center &_td:border-r'>
                      ...
                      <TD className='text-center'>
                        {type.ba_account_name}
                      </TD>
                      <TD className='text-center'>
                        {type.ba_account_number}
                      </TD>
                      <TD className='text-center'>
                        {type.ba_bank_code}
                      </TD>
          ...
          {!isLoading && bank_account?.length == 0 && (
...
export default memo(SettingsBankAccountLists);
