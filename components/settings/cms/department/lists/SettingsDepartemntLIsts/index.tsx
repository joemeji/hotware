...
import { DeleteDepartmentConfirmModal } from "../../modals/DeleteDepartmentConfirmModal";

const SettingsDepartmentLists = () => {
  ...
  const listUrl = `/api/cms/department/paginate?page=${page}&search=${searchText}`;
  ...
  const departments = data?.cms_department;
    ...
    <div className='grid bg-white'>
      ...
      <div className={cn("bg-white p-7", {})}>
        <div className='flex items-center justify-between '>
          <h1 className='text-2xl font-light mb-5'>Manage Departments</h1>
                ...
                departments.map((department: any, i: number) => {
                  return (
                    <tr key={i} className='text-center &_td:border-r'>
                      <TD>{department.cms_department_id}</TD>
                      <TD className='text-left'>
                        {department.cms_department_name}
                      </TD>
                      <TD>
                        <ActionMenu
                          ...
                          data={{
                            id: department.cms_department_id,
                          }}
                        />
                      </TD>
                    </tr>
...
export default memo(SettingsDepartmentLists);