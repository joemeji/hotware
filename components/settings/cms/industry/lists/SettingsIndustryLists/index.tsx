...
const SettingsIndustryLists = () => {
  ...
  const listUrl = `/api/industry/paginate?page=${page}&search=${searchText}`;
  ...
  const industry = data?.cms_industry;
    ...
    <div className='grid bg-white'>
      ...
      <div className={cn("bg-white p-7", {})}>
        <div className='flex items-center justify-between '>
          <h1 className='text-2xl font-light mb-5'>Manage Industries</h1>
                ...
                industry.map((shippingMethod: any, i: number) => {
                  return (
                    <tr key={i} className='text-center &_td:border-r'>
                      ...
                      <TD>
                        <ActionMenu
                          onDelete={() => handleDelete(shippingMethod)}
                          onEdit={() => handleEdit(shippingMethod)}
                          data={{
                            id: shippingMethod.cms_industry_id,
                          }}
                        />
                      </TD>
                    </tr>
...
export default memo(SettingsIndustryLists);