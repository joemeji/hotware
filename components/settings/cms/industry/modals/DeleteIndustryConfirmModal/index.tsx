...
export const DeleteIndustryConrimModal = (props: ICountryModal) => {
      ...
      <div className='pb-5 px-5'>
        <div className='flex flex-col gap-3 justify-center items-center'>
          ...
          <p className="text-lg w-1/2 text-center">
            Are you sure you want to delete {data?.cms_industry_name} ? You won&apos;t be able to revert this.
          </p>
