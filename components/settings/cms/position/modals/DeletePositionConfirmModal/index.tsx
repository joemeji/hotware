...
export const DeletePositionConfirmModal = (props: IPositionModal) => {
  ...
  const deleteCurrency = async() => {
    ...
    try {
      const res = await fetch(
        "/api/cms/position/delete",
        {
          method: "POST",
          body: JSON.stringify({
            id: data.cms_position_id
          })
        },
      );
      ...
      <div className='pb-5 px-5'>
        <div className='flex flex-col gap-3 justify-center items-center'>
          ...
          <p className="text-lg w-1/2 text-center">
            Are you sure you want to delete {data?.cms_position_name} ? You won&apos;t be able to revert this.
          </p>
