...
import { DeleteConfirmModal } from "../../modals/DeleteItemStatusConfirmModal";
import { PER_PAGE } from "@/utils/algoliaConfig";

const SettingsItemStatusLists = () => {
  ...
  const listUrl = `/api/notification/item-status/paginate?page=${page}&search=${searchText}`;
  ...
  const item_status = data?.item_status;
    ...
    <div className='grid bg-white'>
      ...
      <div className={cn("bg-white p-7", {})}>
        <div className='flex items-center justify-between '>
          <h1 className='text-2xl font-light mb-5'>Manage Item Status Reminders</h1>
      ...
      <div className='p-3'>
        <div className='min-h-full'>
          <table className='w-full rounded-sm overflow-hidden p-5'>
            ...
            <tbody>
              {item_status &&
                item_status.length > 0 &&
                item_status.map((type: any, i: number) => {
                  return (
                    <tr key={i} className='text-center &_td:border-r'>
                      ...
                      <TD>
                        <ActionMenu
                          ...
                          data={{
                            id: type.item_status_receiver_id,
                          }}
                        />
                      </TD>
                    </tr>
          ...
          {!isLoading && item_status?.length == 0 && (
...
export default memo(SettingsItemStatusLists);
