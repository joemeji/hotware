...
import SettingsTechnicianDocumentLists from "./lists/SettingsTechnicianDocumentLists";

export const SettingsTechnicianDocument = () => {
  return (
    <div className=''>
      <div className='p-[20px] w-full max-w-[1600px] mx-auto xl:min-h-screen'>
        <div className='rounded-xl mt-4 shadow-sm flex flex-col min-h-[600px]'>
          <SettingsTechnicianDocumentLists />
        </div>
      </div>
    </div>
  );
