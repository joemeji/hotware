...
import { AddDueInvoicesModal } from "../../modals/AddDueInvoicesModal";
import { DeleteConfirmModal } from "../../modals/DeleteDueInvoicesConfirmModal";
import { PER_PAGE } from "@/utils/algoliaConfig";

const SettingsDueInvoicesLists = () => {
  ...
  const listUrl = `/api/notification/due-invoices/paginate?page=${page}&search=${searchText}`;
  ...
  const due_invoices = data?.due_invoices;
    ...
    <div className='grid bg-white'>
      ...
      <div className={cn("bg-white p-7", {})}>
        <div className='flex items-center justify-between '>
          <h1 className='text-2xl font-light mb-5'>Manage Due Invoice Reminders</h1>
      ...
      <div className='p-3'>
        <div className='min-h-full'>
          <table className='w-full rounded-sm overflow-hidden p-5'>
            ...
            <tbody>
              {due_invoices &&
                ...
                due_invoices.map((type: any, i: number) => {
                  return (
          ...
          {!isLoading && due_invoices?.length == 0 && (
...
export default memo(SettingsDueInvoicesLists);
