...
import { AddItemStockModal } from "../../modals/AddItemStockModal";
import { DeleteConfirmModal } from "../../modals/DeleteItemStockConfirmModal";
import { PER_PAGE } from "@/utils/algoliaConfig";

const SettingsItemStockLists = () => {
  ...
  const listUrl = `/api/notification/item-stock/paginate?page=${page}&search=${searchText}`;
  ...
  const item_stock = data?.item_stock;
    ...
    <div className='grid bg-white'>
      ...
      <div className={cn("bg-white p-7", {})}>
        <div className='flex items-center justify-between '>
          <h1 className='text-2xl font-light mb-5'>Manage Item Stock Reminders</h1>
        ...
        <div className='min-h-full'>
          <table className='w-full rounded-sm overflow-hidden p-5'>
            ...
            <tbody>
              {item_stock &&
                item_stock.length > 0 &&
                item_stock.map((type: any, i: number) => {
                  return (
                    <tr key={i} className='text-center &_td:border-r'>
                      ...
                      <TD>
                        <ActionMenu
                          ...
                          data={{
                            id: type.item_stock_receiver_id,
                          }}
                        />
                      </TD>
                    </tr>
...
export default memo(SettingsItemStockLists);
