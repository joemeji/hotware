...
import SettingsCountryLIsts from "./lists/SettingsCountryLIsts";

export const SettingsCountry = () => {
...
export const tableCountryHeadings = [
  {
    name: "#",
  },
  {
  ...
  {
    name: "Maximum Working Hrs/Day",
    class: "text-center",
  },
  {
    name: "Maximum Working Hrs/Week",
    class: "text-center",
  },
  {
    name: "Sunday Work Allowed",
    class: "text-center",
  },
  {
    name: "Installation on Sunday",
    class: "text-center",
  },
  // for action
  {
