...
const SettingsShippingMethodLists = () => {
  ...
  const listUrl = `/api/shipping-method/paginate?page=${page}&search=${searchText}`;
    ...
    <div className='grid bg-white'>
      ...
      <div className={cn("bg-white p-7", {})}>
        <div className='flex items-center justify-between '>
          <h1 className='text-2xl font-light mb-5'>Manage Shipping Methods</h1>
      ...
      <div className='p-3'>
        <div className='min-h-full'>
          ...
          {!isLoading && shippingMethod?.length == 0 && (
...
export default memo(SettingsShippingMethodLists);