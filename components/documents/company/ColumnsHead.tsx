    ...
    return (
        <tr>
          ...
          <Checkbox className="mb-0 rounded-none w-[16px] h-[16px]" />
            ...
            <TH className="bg-stone-300">Name</TH>
            <TH className="bg-stone-300">Category</TH>
            <TH className="bg-stone-300">Lang</TH>
            <TH className="bg-stone-300">ExpiredAt</TH>
            <TH className="bg-stone-300">Modified</TH>
            <TH className="bg-stone-300">ModifiedAt</TH>
            <TH className="bg-stone-300">Status</TH>
