...
import { base, doc_company_base } from "@/lib/azureUrls";
import { doesNotReject } from "assert";
import { CheckedFilesContext, UserAvatar } from "./List";
...
import EditDocument from "./modals/DocumentModal/EditDocument";
import { DeleteDocument } from "./modals/DocumentModal/DeleteDocument";
import DocumentDetails from "./modals/DocumentModal/DocumentDetails";
...
const ColumnsBody = ({
  ...
  const onPreviewDocument = async (filename: any) => {
    ...
    a.href = `${doc_company_base}/${filename}`;
    a.target = "_blank";
    a.click();
  };
