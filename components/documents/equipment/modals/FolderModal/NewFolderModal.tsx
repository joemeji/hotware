...
function NewFolderModal(props: NewFolderModalProps) {
  ...
  let paramsObj: any = { parent_id: String(parentID), user_id: itemID };
  let searchParams = new URLSearchParams(paramsObj);

  async function onSave(data: any) {
    const res = await fetch(`${baseUrl}/api/document/equipment/create_equipment_folder/${parentID}/${itemID}`, {
      method: 'POST',
