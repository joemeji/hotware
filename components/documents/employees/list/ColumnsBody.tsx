...
import EditDocument from "../modals/NewDocumentModal/EditDocument";
import { DeleteDocument } from "../modals/NewDocumentModal/DeleteDocument";
import DocumentDetails from "../modals/NewDocumentModal/DocumentDetails";
...
const ColumnsBody = ({
  ...
  const onPreviewDocument = async (filename: any) => {
    ...
    a.href = base + `/documents/employee/${filename}`;;
    a.target = "_blank";
    a.click();
  };
      ...
      {!selectedEmployee && (
        <TD className="border">
          <div className="flex justify-center">
            <UserAvatar
              firstname={dir.owner_firstname}
              lastname={dir.owner_lastname}
              avatar_color={dir.owner_avatar_color}
              photo={dir.owner_photo}
            />
          </div>
        </TD>
      )}
...
const Directory = ({ dir }: { dir: any }) => {
  ...
  const onClick = () => {
    ...
    query.user_id = dir.owner__user_id;
